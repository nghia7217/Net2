    ...
    public class AccountController : BaseController {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model) {
            if (ModelState.IsValid) {
                ...
                await UserManager.SendEmailAsync(user.Id, "Đặt lại mật khẩu", "Vui lòng đặt lại mật khẩu của bạn bằng cách nhấn vào <a href=\"" + callbackUrl + "\">đây</a>");
        ...
        public ActionResult LogOff() {
            ...
            var loginSessions = db.LoginSessions.Where(x => x.CreatedBy == userId && !x.LogoffTime.HasValue).ToList();
            loginSessions.ForEach(x => x.LogoffTime = DateTime.Now);
            db.SaveChanges();
